...
public:
    /**
		 ...
		 */
    GaussianView(const sibr::BasicIBRScene::Ptr &ibrScene, uint render_w, uint render_h, std::string plyPath,
                 bool *message_read, bool white_bg = false, bool useInterop = true, int device = 0,
                 int appearance_id = 0, bool add_opacity_dist = true, bool add_cov_dist = true,
