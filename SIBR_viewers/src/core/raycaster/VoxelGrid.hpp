...
template <typename CellType = BasicVoxelType>
...
template <typename CellType>
inline sibr::Mesh::Ptr VoxelGrid<CellType>::getAllCellMeshWithIds(bool filled,
                                                                  std::vector<std::size_t> cell_ids) const {
